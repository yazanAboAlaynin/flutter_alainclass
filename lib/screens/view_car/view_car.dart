            ...
            builder: (BuildContext context) {
              return AlertDialog(
                ...
                content: SingleChildScrollView(
                  child: ListBody(
                    children: <Widget>[
                      Text('Your enquiry sent successfuly\nthank you.'),
                    ],
                  ),
                ),
                actions: <Widget>[
      ...
      child: BlocBuilder(
        ...
        builder: (context, state) {
          ...
          if (state is CarLoadSuccess || state is ImagesLoadInProgress) {
            if (state is CarLoadSuccess) images = state.images;
          ...
          """,
                    ...
                    Container(
                      ...
                      child: state is ImagesLoadInProgress
                          ? Center(
                              child: CircularProgressIndicator(),
                            )
                          : ManuallyControlledSlider(images: images),
                    ),
                    SizedBox(
                      height: sizeAware.height * 0.02,
                    ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                                color: Colors.grey, fontFamily: 'Gentium'),
                          ),
                          SizedBox(
                            height: sizeAware.height * 0.02,
                          ),
